    ...
    <section className="flex min-h-[calc(100vh-7rem)] flex-col gap-6">
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <input
          ...
          className="mt-2 block w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-slate-900 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-teal-600 focus:ring-4 focus:ring-teal-100 sm:w-80"
        />
      </div>
      <SuppliersTable
        suppliers={suppliers}
